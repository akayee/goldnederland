...
class HomePageThree extends React.Component {
   ...
   //get banner data
   getBannerData() {
      const bannerRef = firebase.database().ref('goldnederland/banner_three');
   ...
   getSiteFeaturesTwo() {
      const siteFeaturesRef = firebase.database().ref('goldnederland/site_features_two');
   ...
   //get gallery data
   getGallery() {
      const galleryRef = firebase.database().ref('goldnederland/collection_gallery');
