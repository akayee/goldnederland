...
class HomePageOne extends React.Component {
   ...
   //get banner data
   getBannerData() {
      const bannerRef = firebase.database().ref('goldnederland/banner_one');
   ...
   //get blogs data
   getblogs() {
      const blogsRef = firebase.database().ref('goldnederland/blogs');
   ...
   //site features data
   getSiteFeatures() {
      const siteFeaturesRef = firebase.database().ref('goldnederland/site_features');
